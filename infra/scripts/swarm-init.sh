...
echo "Run this command on each worker node (server_5 and server_6):"
echo ""
...
echo "  docker node ls"
echo ""
echo "  # Label server_5 (192.168.10.116):"
echo "  docker node update --label-add role=compute <server_5_node_id>"
echo ""
